# Contributing to dioxus-ntf-poc

dioxus-ntf-poc is written in [Rust](https://www.rust-lang.org/).
...
2. Clone your fork to a local repository:
        ...
        git clone https://github.com/you/dioxus-ntf-poc.git
        cd dioxus-ntf-poc

3. Add the main repository as a remote:

        git remote add upstream https://github.com/ejpcmac/dioxus-ntf-poc.git
        git fetch --all
